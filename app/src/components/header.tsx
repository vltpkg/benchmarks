  ...
  return (
    <div className="relative flex bg-card items-center gap-2.5 px-3 py-2 rounded-lg border border-border/50 flex-shrink-0 whitespace-nowrap min-w-[120px]">
      ...
      <div className="flex items-center gap-2.5">
        <div className="items-center justify-center flex flex-shrink-0 w-7 h-7">
          {Icon && (
            <Icon
              size={28}
              className={cn((packageManager === "vlt" || packageManager === "github" || packageManager === "vp") && "dark:text-white")}
            />
          )}
        </div>
