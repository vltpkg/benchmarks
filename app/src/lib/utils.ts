...
export function getPackageManagerLogo(packageManager: PackageManager): string | undefined {
  const logoMap: Record<PackageManager, string | undefined> = {
